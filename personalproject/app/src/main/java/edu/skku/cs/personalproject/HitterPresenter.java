...
public class HitterPresenter implements Contract.ContractForHitterPresenter, Contract.ContractForHitterModel.OnValueChangedListener {
    private Contract.ContractForHitterView view;
    private Contract.ContractForHitterModel model;

    public HitterPresenter(Contract.ContractForHitterView view, Contract.ContractForHitterModel model) {
        this.view = view;
        this.model = model;
    }
